...
function Teams() {
    ...
    return (
        <div className="team-container">
            <header>
                <Link to={"/"}><span>FutBrasil</span></Link>
                ...
                <tbody>
                    {teams.map(team => (
                        <tr key={team.id}>
                            ...
                            <td>{team.derrotas}</td>
                            <td>{team.empates}</td>
                            <td>{team.golsMarcados}</td>
                            <td>{team.golsSofridos}</td>
                            <td>{team.saldoGols}</td>
                            <td className="table-options">
                                <FiEdit3 onClick={() => editTeam(team.id)} size={18} color="#251fc5"/> 
                                <FiTrash2 onClick={() => deleteTeam(team.id)} size={18} color="red"/>
                            </td>
                        </tr>
                    ))}    
                </tbody>
